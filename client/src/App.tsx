...
function Router() {
  return (
    <Switch>
      ...
      <ProtectedRoute path="/quizzes/:studentQuizId/results" component={StudentResultsPage} exact />
      <ProtectedRoute path="/quizzes/:quizId/results-summary" component={QuizResultsSummaryPage} exact />
